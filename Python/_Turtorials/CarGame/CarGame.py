...
def countdown_background():
    ...
    speed=font.render("Speed: 0",True,black)
    gamedisplays.blit(text,(0,50))
    gamedisplays.blit(score,(0,30))
    gamedisplays.blit(speed,(0,70))
...
def score_system(passed,score,obstacle_speed,level):
    font=pygame.font.SysFont(None,25)
    text=font.render("Passed: "+str(passed),True,black)
    score=font.render("Score: "+str(score),True,red)
    speed=font.render("Speed: "+str(obstacle_speed),True,black)
    level=font.render("Level: "+str(level),True,black)
    gamedisplays.blit(text,(0,50))
    gamedisplays.blit(score,(0,30))
    gamedisplays.blit(speed,(0,70))
    gamedisplays.blit(level,(0,90))
...
def game_loop():
    ...
    while not bumped:
        ...
        car(x,y)
        score_system(passed,score,obstacle_speed,level)
